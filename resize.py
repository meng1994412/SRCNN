...
# resize the input image using bicubic interpolation then write the basline
# image to disk
...
# remove any of the black borders in the output image caused by the padding
# then clip any values that fall outside the range [0, 255]
